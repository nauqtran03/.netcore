...
//        => optionsBuilder.UseSqlServer("Server=(localdb)\\mssqllocaldb;Database=DEVXUONGMOC;Trusted_Connection=True;MultipleActiveResultSets=True; TrustServerCertificate=True");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__PARTNER__3214EC2769197DD9");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__SLIDES__3214EC274A5479B1");
